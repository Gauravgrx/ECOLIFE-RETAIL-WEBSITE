        ...
        <div id="main">
          ...
          <section className="column is-offset-6 is-4">
            <center>
                              ...
                              <div className="login-register-form">
                                <form action="/login" method="post">
                                  ...
                                  <div className="button-box">
                                    ...
                                    <button type="submit" value="Login" name="regOrLogin" class="class1"><span>Login</span></button>
                                  </div>
                                </form>
                              </div>
                            </div>
              ...
              <td align="center" colspan="2"><Link to='/register' ><button>Register</button></Link></td>
            </center>
          </section>
          {/* Footer Area start */}
